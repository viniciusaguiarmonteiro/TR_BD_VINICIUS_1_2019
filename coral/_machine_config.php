...
GlobalConfig::$CONNECTION_SETTING->DBName = "coral";
...
/** the root url of the application with trailing slash, for example http://localhost/coral/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'coral/';
