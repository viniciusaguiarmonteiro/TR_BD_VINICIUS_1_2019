	...
	*/
	static function GetCustomQuery($criteria)
	{
		$sql = "select
			...
			,`funcionario`.`Matricula_Funcionario` as MatriculaFuncionario
			,`funcionario`.`DIRETORIA_Id_Diretoria` as DiretoriaIdDiretoria
			,`funcionario`.`usuario_CPF_Usuario` as UsuarioCpfUsuario
		from `funcionario`";
