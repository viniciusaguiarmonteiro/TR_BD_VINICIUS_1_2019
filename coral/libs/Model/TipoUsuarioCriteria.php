...
require_once("DAO/TipoUsuarioCriteriaDAO.php");

/**
 * The TipoUsuarioCriteria class extends TipoUsuarioDAOCriteria and is used
 ...
 * @version 1.0
 */
class TipoUsuarioCriteria extends TipoUsuarioCriteriaDAO
{
