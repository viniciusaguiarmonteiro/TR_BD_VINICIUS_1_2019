...
require_once("DAO/DenunciaRelatoCriteriaDAO.php");

/**
 * The DenunciaRelatoCriteria class extends DenunciaRelatoDAOCriteria and is used
 ...
 * @version 1.0
 */
class DenunciaRelatoCriteria extends DenunciaRelatoCriteriaDAO
{
