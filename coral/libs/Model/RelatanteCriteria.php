...
require_once("DAO/RelatanteCriteriaDAO.php");

/**
 * The RelatanteCriteria class extends RelatanteDAOCriteria and is used
 ...
 * @version 1.0
 */
class RelatanteCriteria extends RelatanteCriteriaDAO
{
