...
require_once("DAO/LocalPermitidoCriteriaDAO.php");

/**
 * The LocalPermitidoCriteria class extends LocalPermitidoDAOCriteria and is used
 ...
 * @version 1.0
 */
class LocalPermitidoCriteria extends LocalPermitidoCriteriaDAO
{
