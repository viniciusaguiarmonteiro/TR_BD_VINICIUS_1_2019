...
require_once("DAO/LogLoginCriteriaDAO.php");

/**
 * The LogLoginCriteria class extends LogLoginDAOCriteria and is used
 ...
 * @version 1.0
 */
class LogLoginCriteria extends LogLoginCriteriaDAO
{
