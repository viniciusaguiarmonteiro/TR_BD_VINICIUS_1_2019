...
require_once("DAO/DiretoriaCriteriaDAO.php");

/**
 * The DiretoriaCriteria class extends DiretoriaDAOCriteria and is used
 ...
 * @version 1.0
 */
class DiretoriaCriteria extends DiretoriaCriteriaDAO
{
