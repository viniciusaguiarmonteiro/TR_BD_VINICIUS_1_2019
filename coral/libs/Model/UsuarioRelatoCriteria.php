...
require_once("DAO/UsuarioRelatoCriteriaDAO.php");

/**
 * The UsuarioRelatoCriteria class extends UsuarioRelatoDAOCriteria and is used
 ...
 * @version 1.0
 */
class UsuarioRelatoCriteria extends UsuarioRelatoCriteriaDAO
{
