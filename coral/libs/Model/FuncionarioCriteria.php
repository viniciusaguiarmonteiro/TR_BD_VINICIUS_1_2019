...
require_once("DAO/FuncionarioCriteriaDAO.php");

/**
 * The FuncionarioCriteria class extends FuncionarioDAOCriteria and is used
 ...
 * @version 1.0
 */
class FuncionarioCriteria extends FuncionarioCriteriaDAO
{
