...
require_once("DAO/CategoriaRelatoCriteriaDAO.php");

/**
 * The CategoriaRelatoCriteria class extends CategoriaRelatoDAOCriteria and is used
 ...
 * @version 1.0
 */
class CategoriaRelatoCriteria extends CategoriaRelatoCriteriaDAO
{
