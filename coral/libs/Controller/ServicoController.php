...
class ServicoController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('IdServico,TituloServico,DescricaoServico,DiretoriaIdDiretoria'
				, '%'.$filter.'%')
			);
	...
	public function Read()
	{
		try
		{
			$pk = $this->GetRouter()->GetUrlParam('idServico');
	...
	public function Create()
	{
		try
		{
			...
			// $servico->IdServico = $this->SafeGetVal($json, 'idServico');

			$servico->TituloServico = $this->SafeGetVal($json, 'tituloServico');
			$servico->DescricaoServico = $this->SafeGetVal($json, 'descricaoServico');
			$servico->DiretoriaIdDiretoria = $this->SafeGetVal($json, 'diretoriaIdDiretoria');
	...
	public function Update()
	{
		try
		{
			...
			// $servico->IdServico = $this->SafeGetVal($json, 'idServico', $servico->IdServico);

			$servico->TituloServico = $this->SafeGetVal($json, 'tituloServico', $servico->TituloServico);
			$servico->DescricaoServico = $this->SafeGetVal($json, 'descricaoServico', $servico->DescricaoServico);
			$servico->DiretoriaIdDiretoria = $this->SafeGetVal($json, 'diretoriaIdDiretoria', $servico->DiretoriaIdDiretoria);
